...
import '../screens/product_detail/my_trip.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ClipRRect(
                borderRadius: BorderRadius.circular(12.0),
                child: cafeImage.startsWith('http')
                    ? Image.network(
                  cafeImage,
                  width: 170,
                  height: 170,
          ...
          //           Navigator.push(
          //             context,
          //             MaterialPageRoute(builder: (context) => GoogleMapPolyline(tourId: null,)),
          //           );
          //         },
          //         child:
          //         Row(
          //           children: const [
          //             Icon(Iconsax.location, color: Color(0xFF55B97D)),
          //             SizedBox(width: 8.0),
          //             Text(
          //               'From your current location to all destinations',
          //               style: TextStyle(
          //                   fontSize: 16,
