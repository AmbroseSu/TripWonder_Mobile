...
import 'package:tripwonder/widgets/rating_progress_indicator.dart';
    ...
    return Column(
      children: [
        ...
        ReadMoreText(
          ...
          moreStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF55B97D),),
          lessStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Color(0xFF55B97D),)
        ),
        const SizedBox(height: TSizes.spaceBtwItems),
